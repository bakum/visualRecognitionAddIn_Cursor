...
protected:
    ...
    void AddProperty(const std::u16string &alias, const std::u16string &alias_ru,
    ...
    void AddMethod(const std::u16string &alias, const std::u16string &alias_ru, C *c, T(C::*f)(Ts ...),
...
template<typename T, typename C, typename ... Ts>
void Component::AddMethod(const std::u16string &alias, const std::u16string &alias_ru, C *c, T(C::*f)(Ts ...),
                          std::map<long, variant_t> &&def_args) {
