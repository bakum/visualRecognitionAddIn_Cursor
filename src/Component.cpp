...
std::u16string toU16String(std::basic_string_view<WCHAR_T> src) {
...
long Component::FindProp(const WCHAR_T* prop_name) {
	...
	const std::u16string lookup_name = toU16String(prop_name);
...
const WCHAR_T* Component::GetPropName(long num, long lang_alias) {
	...
	const std::u16string* name = (lang_alias == 0)
		? &properties_meta[num].alias
		: &properties_meta[num].alias_ru;
...
long Component::FindMethod(const WCHAR_T* method_name) {
	...
	const std::u16string lookup_name = toU16String(method_name);
...
const WCHAR_T* Component::GetMethodName(const long num, const long lang_alias) {
	...
	const std::u16string* name = (lang_alias == 0)
		? &methods_meta[num].alias
		: &methods_meta[num].alias_ru;
...
void Component::AddProperty(const std::u16string& alias, const std::u16string& alias_ru,
